...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{url('/')}}/app-assets/css/all.css">
  <!-- END Custom CSS-->
</head>
<body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns menu-collapsed fixed-navbar">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a href="index.html" class="navbar-brand">
              <img alt="stack admin logo" src="../../../app-assets/images/logo/stack-logo.png"
              class="brand-logo">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img src="../../../app-assets/images/slider/slider-2.png" alt="First slide" class="rounded img-fluid mb-1"><a href="#" class="news-title mb-0">Poster Frame PSD</a>
  ...
  <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
    <div class="main-menu-content">
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        ...
        <li class=" nav-item"><a href="index.html"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span><span class="badge badge badge-primary badge-pill float-right mr-2">3</span></a>
        ...
        <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span data-i18n="" class="menu-title">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
          <ul class="menu-content">
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-1-column.html"
              class="menu-item">1 column</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-2-columns.html"
              class="menu-item">2 columns</a>
            </li>
            <li><a href="#" class="menu-item">Content Det. Sidebar</a>
              <ul class="menu-content">
                <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-content-detached-left-sidebar.html"
                  class="menu-item">Detached left sidebar</a>
                </li>
                <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-content-detached-left-sticky-sidebar.html"
                  class="menu-item">Detached sticky left sidebar</a>
                </li>
                <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-content-detached-right-sidebar.html"
                  class="menu-item">Detached right sidebar</a>
                </li>
                <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-content-detached-right-sticky-sidebar.html"
                  class="menu-item">Detached sticky right sidebar</a>
                </li>
              </ul>
            </li>
            <li class="navigation-divider"></li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-fixed-navbar.html"
              class="menu-item">Fixed navbar</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-fixed-navigation.html"
              class="menu-item">Fixed navigation</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-fixed-navbar-navigation.html"
              class="menu-item">Fixed navbar &amp; navigation</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-fixed-navbar-footer.html"
              class="menu-item">Fixed navbar &amp; footer</a>
            </li>
            <li class="navigation-divider"></li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-fixed.html"
              class="menu-item">Fixed layout</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-boxed.html"
              class="menu-item">Boxed layout</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-static.html"
              class="menu-item">Static layout</a>
            </li>
            <li class="navigation-divider"></li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-light.html"
              class="menu-item">Light layout</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-dark.html"
              class="menu-item">Dark layout</a>
            </li>
            <li><a href="../../../starter-kit/ltr/vertical-menu-template/layout-semi-dark.html"
              class="menu-item">Semi dark layout</a>
            </li>
          </ul>
        </li>
        <li class=" navigation-header">
          <span>Apps</span><i data-toggle="tooltip" data-placement="right" data-original-title="Apps"
          class=" ft-minus"></i>
        </li>
        ...
        <li class=" navigation-header">
          <span>UI</span><i data-toggle="tooltip" data-placement="right" data-original-title="UI"
        ...
        <li class=" nav-item"><a href="#"><i class="ft-square"></i><span data-i18n="" class="menu-title">Cards</span><span class="badge badge badge-pill badge-success float-right mr-2">Hot</span></a>
          <ul class="menu-content">
        ...
        <li class=" nav-item"><a href="#"><i class="ft-droplet"></i><span data-i18n="" class="menu-title">Color Palette</span><span class="badge badge badge-warning badge-pill float-right mr-2">14</span></a>
          <ul class="menu-content">
        ...
        <li class=" navigation-header">
          <span>Components</span><i data-toggle="tooltip" data-placement="right" data-original-title="Components"
          class=" ft-minus"></i>
        </li>
        <li class=" nav-item"><a href="#"><i class="ft-briefcase"></i><span data-i18n="" class="menu-title">Bootstrap Components</span></a>
          <ul class="menu-content">
            ...
            <li><a href="component-badges.html" class="menu-item">Badges</a>
            </li>
            <li><a href="component-pill-badges.html" class="menu-item">Pill Badges</a>
            </li>
        ...
        <li class=" nav-item"><a href="#"><i class="ft-edit"></i><span data-i18n="" class="menu-title">Forms</span></a>
          <ul class="menu-content">
            <li><a href="#" class="menu-item">Form Elements</a>
              <ul class="menu-content">
                <li class="active"><a href="form-inputs.html" class="menu-item">Form Inputs</a>
                </li>
            ...
            <li><a href="form-dual-listbox.html" data-i18n="nav.form_elements.form_dual_listbox"
              class="menu-item">Dual Listbox</a>
            </li>
            ...
            <li><a href="#" class="menu-item">DataTables</a>
              <ul class="menu-content">
                ...
                <li><a href="#" data-i18n="nav.datatable_extensions.main" class="menu-item">DataTables Ext.</a>
                  <ul class="menu-content">
                    <li><a href="dt-extensions-autofill.html" data-i18n="nav.datatable_extensions.dt_extensions_autofill"
                      class="menu-item">AutoFill</a>
                    </li>
                    <li><a href="#" data-i18n="nav.datatable_extensions.datatable_buttons.main"
                      class="menu-item">Buttons</a>
                      <ul class="menu-content">
                        <li><a href="dt-extensions-buttons-basic.html" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_basic"
                          class="menu-item">Basic Buttons</a>
                        </li>
                        <li><a href="dt-extensions-buttons-html-5-data-export.html" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_html_5_data_export"
                          class="menu-item">HTML 5 Data Export</a>
                        </li>
                        <li><a href="dt-extensions-buttons-flash-data-export.html" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_flash_data_export"
                          class="menu-item">Flash Data Export</a>
                        </li>
                        <li><a href="dt-extensions-buttons-column-visibility.html" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_column_visibility"
                          class="menu-item">Column Visibility</a>
                        </li>
                        <li><a href="dt-extensions-buttons-print.html" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_print"
                          class="menu-item">Print</a>
                        </li>
                        <li><a href="dt-extensions-buttons-api.html" data-i18n="nav.datatable_extensions.datatable_buttons.dt_extensions_buttons_api"
                          class="menu-item">API</a>
                        </li>
                      </ul>
                    </li>
                    <li><a href="dt-extensions-column-reorder.html" data-i18n="nav.datatable_extensions.dt_extensions_column_reorder"
                      class="menu-item">Column Reorder</a>
                    </li>
                    <li><a href="dt-extensions-fixed-columns.html" data-i18n="nav.datatable_extensions.dt_extensions_fixed_columns"
                      class="menu-item">Fixed Columns</a>
                    </li>
                    <li><a href="dt-extensions-key-table.html" data-i18n="nav.datatable_extensions.dt_extensions_key_table"
                      class="menu-item">Key Table</a>
                    </li>
                    <li><a href="dt-extensions-row-reorder.html" data-i18n="nav.datatable_extensions.dt_extensions_row_reorder"
                      class="menu-item">Row Reorder</a>
                    </li>
                    <li><a href="dt-extensions-select.html" data-i18n="nav.datatable_extensions.dt_extensions_select"
                      class="menu-item">Select</a>
                    </li>
                    <li><a href="dt-extensions-fix-header.html" data-i18n="nav.datatable_extensions.dt_extensions_fix_header"
                      class="menu-item">Fix Header</a>
                    </li>
                    <li><a href="dt-extensions-responsive.html" data-i18n="nav.datatable_extensions.dt_extensions_responsive"
                      class="menu-item">Responsive</a>
                    </li>
                    <li><a href="dt-extensions-column-visibility.html" data-i18n="nav.datatable_extensions.dt_extensions_column_visibility"
                      class="menu-item">Column Visibility</a>
                    </li>
                  </ul>
                </li>
        ...
        <li class=" navigation-header">
          <span>Others</span><i data-toggle="tooltip" data-placement="right" data-original-title="Others"
          class=" ft-minus"></i>
        </li>
        ...
        <li class=" nav-item"><a href="changelog.html"><i class="ft-file"></i><span data-i18n="" class="menu-title">Changelog</span><span class="badge badge badge-pill badge-info float-right">2.1</span></a>
        </li>
  ...
  <!-- Content Section Yeild -->

  @yield('content')

  <!-- Content Section Yeild End -->
  <!-- ////////////////////////////////////////////////////////////////////////////-->
  <footer class="footer footer-static footer-dark navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2 content">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; {{date('Y')}} <a href="https://anzglobalsoft.com"
        target="_blank" class="text-bold-800 grey darken-2">ANZ GLOBAL SOFT (Pvt.) Ltd. </a>, All rights
        reserved. </span>
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Hand-crafted & Made with <i class="ft-heart pink"></i></span>
    </p>
  </footer>
  <script src="{{url('/')}}/js/app.js" type="text/javascript"></script>
  <script src="{{url('/')}}/app-assets/js/bundle.js" type="text/javascript"></script>
  <script>
