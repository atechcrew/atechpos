  ...
  <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
    <div class="main-menu-content">
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        ...
        <li class=" nav-item"><a href="index.html"><i class="fa fa-product-hunt"></i><span data-i18n="" class="menu-title">Products</span></a>
          <ul class="menu-content">
            <li><a href="{{url('/')}}/category" class="menu-item">Categories</a>
            </li>
            <li><a href="{{url('/')}}/brand" class="menu-item">Brands</a>
            </li>
            <li><a href="{{url('/')}}/product" class="menu-item">Product</a>
            </li>
          </ul>
        </li>
      </ul>
